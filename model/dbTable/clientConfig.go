...
type ClientConfig struct {
	...
	Namespace string `gorm:"uniqueIndex:idx_client_configs_school_grade_class,priority:1;not null;size:128;default:default"`
	School    string `gorm:"uniqueIndex:idx_client_configs_school_grade_class,priority:2;not null;size:50"`
