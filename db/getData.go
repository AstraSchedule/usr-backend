...
func GetLatestVersion(school string, grade string, class string) *carbon.Carbon {
	...
	GetDB().Where("school = ? AND grade = ? AND class = ?", school, grade, class).Take(latestVersion)
